package com.qlda.backend.statistics.service;
...
public class StatisticsService {
    ...
    public ProjectOverviewDto getProjectOverview(String projectId) {
        ...
        List<com.qlda.backend.columns.entity.ColumnEntity> columns = columnRepository.findByProjectId(projectId);
        List<String> columnIds = columns.stream()
                .map(com.qlda.backend.columns.entity.ColumnEntity::getId)
    ...
    public List<MemberStatisticsDto> getMemberStatistics(String projectId) {
        ...
        for (TaskEntity task : tasks) {
            if (task.getAssignees() != null) {
                for (com.qlda.backend.users.entity.UserEntity assignee : task.getAssignees()) {
