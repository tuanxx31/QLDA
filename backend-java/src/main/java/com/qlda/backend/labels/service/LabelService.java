package com.qlda.backend.labels.service;
...
public class LabelService {
    ...
    public Object create(CreateLabelDto dto) {
        ...
        boolean isExist = existing.stream()
                .anyMatch(l -> l.getName() != null && l.getName().equals(trimmedName) &&
                        l.getColor().equals(dto.getColor()));

        if (isExist) {
            LabelEntity found = existing.stream()
                    .filter(l -> l.getName() != null && l.getName().equals(trimmedName) &&
                            l.getColor().equals(dto.getColor()))
                    .findFirst()
                    .orElse(null);
            if (found != null) {
                Map<String, Object> response = new HashMap<>();
                response.put("message", "Label already exists in this project");
    ...
    public Map<String, String> remove(String id) {
        ...
        response.put("message", "Label removed successfully");
        return response;
    }
}
