package com.qlda.backend.tasks.service;
...
import com.qlda.backend.labels.repository.LabelRepository;
import com.qlda.backend.permissions.service.PermissionService;
import com.qlda.backend.projectmember.repository.ProjectMemberRepository;
import com.qlda.backend.subtasks.entity.SubTaskEntity;
import com.qlda.backend.subtasks.repository.SubTaskRepository;
...
public class TaskService {
    ...
    public TaskEntity findOne(String id) {
        ...
        if (column != null && column.getProject() != null) {
            ...
            List<com.qlda.backend.projectmember.entity.ProjectMemberEntity> projectMembers =
    ...
    public TaskEntity update(String id, UpdateTaskDto dto, String userId) {
        ...
        if (column != null && column.getProject() != null) {
            if (!permissionService.canEditTask(column.getProject().getId(), userId)) {
